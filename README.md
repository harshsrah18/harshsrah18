...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=5B8CFF&center=true&vCenter=true&width=700&lines=Full+Stack+Developer;Shipped+a+Live+AI+SaaS+with+Razorpay+%2B+Firebase+Auth;MERN+Stack+Developer;Always+Learning+New+Technologies)](https://git.io/typing-svg)
...
- MongoDB & Mongoose
- Redis (key-value store, sub-10ms lookups)
...
- Prompt Engineering for structured question generation
- AI resume-parsing pipelines (PDF → skills/experience extraction)
- AI-generated answer evaluation & feedback
...
| 📘 Higher Secondary (Class 12, Science) | Sree Narayana Vidyalaya English Medium Hs & Jr College, Kanhan | 2019 – 2021 | — |
...
[![](https://leetcard.jacoblin.cool/HarshsraH?theme=dark&font=Nunito&ext=contest)](https://leetcode.com/u/HarshsraH/)
